...
- Harden machine-readable command contracts for automation (`/plan`, `/implement`, `/creview`, `/mreview`, `/repair`, `/phreview`).
...
- Keywords: opencode, command, slash command, tool schema, deterministic output, phase loop, plan, implement, creview, mreview, repair, phreview, session automation, machine-readable marker, noReply.
